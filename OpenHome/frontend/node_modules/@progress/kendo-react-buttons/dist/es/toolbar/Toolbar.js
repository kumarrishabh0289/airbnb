...
var Toolbar = /** @class */ (function (_super) {
    ...
    Toolbar.prototype.render = function () {
        var _this = this;
        this.counter = 0;
        return (React.createElement("div", { className: classNames('k-widget k-toolbar', this.props.className), style: this.props.style, role: "toolbar", dir: this.props.dir, ref: function (element) { return _this._element = element; }, onKeyDown: this.onKeyDown }, React.Children.map(this.props.children, this.mapToolbarChild)));
    };
