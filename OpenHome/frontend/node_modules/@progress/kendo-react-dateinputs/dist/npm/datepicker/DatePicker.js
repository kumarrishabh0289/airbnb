...
var DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.render = function () {
        ...
        var rootClassName = kendo_react_common_1.classNames('k-widget k-datepicker', {
        ...
        var calendar = this.props.calendar
            ...
            : React.createElement(Calendar_1.Calendar, __assign({ ref: this.setCalendarRef }, calendarProps));
        return (React.createElement("span", { role: "group", "aria-expanded": this.show, ref: function (span) { _this._element = span; }, className: rootClassName, onKeyDown: this.handleKeyDown, style: { width: width }, onFocus: this.handleFocus, onBlur: this.handleBlur },
            React.createElement("span", { ref: function (span) { _this._wrapper = span; }, className: wrapperClassNames },
                ...
                React.createElement("span", __assign({ role: "button", onMouseDown: this.handleIconMouseDown, onClick: this.handleIconClick, title: kendo_react_intl_1.provideLocalizationService(this)
